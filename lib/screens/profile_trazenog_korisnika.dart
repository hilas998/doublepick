...
class ProfileTrazenogKorisnikaScreen extends StatefulWidget {
  final String uid;
  const ProfileTrazenogKorisnikaScreen({super.key, required this.uid});

  @override
  State<ProfileTrazenogKorisnikaScreen> createState() => _ProfileTrazenogKorisnikaScreenState();
}

class _ProfileTrazenogKorisnikaScreenState extends State<ProfileTrazenogKorisnikaScreen> {
  int? selectedRound;
